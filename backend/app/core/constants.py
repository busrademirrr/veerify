...
# puan eşikleri
SIMILARITY_THRESHOLD = 0.25  # Pre-filter threshold (Lowered to allow partial matches to pass to scoring)
DIVERSITY_THRESHOLD = 10  # çeşitlilik faktörü için gerekli kaynak sayısı
MIN_SOURCES_FOR_VERIFICATION = 1  # doğrulama denemesi için gerekli minimum kaynak

# puan karar verme için gerekli aralıklar
# puan karar verme için gerekli aralıklar (11 Kaynak için optimize edildi)
SCORE_VERIFIED = 0.60      # ~7+ kaynak
SCORE_LIKELY_TRUE = 0.25   # ~3+ kaynak (User: %45 kesinlikle şüpheli olmasın)
SCORE_UNCERTAIN = 0.10     # ~1-2 kaynak
SCORE_DISPUTED = 0.01      # ~1 kaynak

# kaynak sayı gereklilikleri (11 kaynak için düşürüldü)
MIN_SOURCES_VERIFIED = 6
MIN_SOURCES_LIKELY_TRUE = 3
MIN_SOURCES_UNCERTAIN = 1
MIN_SOURCES_DISPUTED = 0
...
SPACY_MODEL_NAME = "tr_core_news_md"  # türkçe dil modeli
...
MIN_SEARCH_TEXT_LENGTH = 15  # Database araması için minimum karakter (daha kısa ise invalid_input döner)
