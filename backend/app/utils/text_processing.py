...
class TextProcessor:
    ...
    def prepare_for_similarity_search(self, text: str,validate_length:bool=True) -> str:
        """
...
def prepare_for_similarity_search(text: str, validate_length: bool = True) -> str:
    """
    ...
    """
    processor = TextProcessor()
    return processor.prepare_for_similarity_search(text,validate_length=validate_length)
...
def extract_keywords(
    ...
    """
    processor = TextProcessor()
    return processor.extract_keywords(
        text, 
